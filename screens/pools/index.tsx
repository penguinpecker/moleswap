    ...
    <div className="flex flex-col gap-3">
      ...
      {!isConnected ? (
        ...
        <div className="py-4 text-center">
          ...
          {txHash && <a href={`https://donut.push.network/tx/${txHash}`} target="_blank" rel="noopener noreferrer" className="font-family-ThaleahFat text-peach-300 mt-1 block text-base underline">VIEW ON EXPLORER →</a>}
